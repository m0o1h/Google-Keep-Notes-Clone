...
import { View, Text, TouchableOpacity, TextInput, Keyboard, Modal, TouchableWithoutFeedback, Image, KeyboardAvoidingView } from 'react-native';
...
export default function AddTaskPage({navigation}) {
  ...
  const [color, setColor] = useState('#252527');
